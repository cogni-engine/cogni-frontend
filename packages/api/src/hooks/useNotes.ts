...
interface UseNotesReturn {
  ...
  createNote: (title: string, content: string, folderId?: number | null) => Promise<NoteWithParsed>;
  updateNote: (id: number, title: string, content: string) => Promise<NoteWithParsed>;
