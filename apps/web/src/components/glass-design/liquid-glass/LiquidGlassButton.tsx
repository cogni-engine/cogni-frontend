...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <div
      className='absolute inset-0 rounded-full overflow-hidden isolate backdrop-saturate-[1.8]'
      style={{
    ...
    {/* Inner glow border */}
    <div className='absolute inset-0 rounded-full overflow-hidden shadow-[inset_2px_2px_0px_-2px_rgba(255,255,255,0.7),inset_0_0_3px_1px_rgba(255,255,255,0.7)] pointer-events-none' />
