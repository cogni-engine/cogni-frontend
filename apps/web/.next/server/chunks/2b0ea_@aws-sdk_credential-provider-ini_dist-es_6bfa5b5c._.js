module.exports = [
"[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-ini@3.927.0/node_modules/@aws-sdk/credential-provider-ini/dist-es/index.js [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
;
}),
"[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-ini@3.927.0/node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveCredentialSource.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cogni$2f$cogni$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$smithy$2b$property$2d$provider$40$4$2e$2$2e$4$2f$node_modules$2f40$smithy$2f$property$2d$provider$2f$dist$2d$es$2f$chain$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@smithy+property-provider@4.2.4/node_modules/@smithy/property-provider/dist-es/chain.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cogni$2f$cogni$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$smithy$2b$property$2d$provider$40$4$2e$2$2e$4$2f$node_modules$2f40$smithy$2f$property$2d$provider$2f$dist$2d$es$2f$CredentialsProviderError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@smithy+property-provider@4.2.4/node_modules/@smithy/property-provider/dist-es/CredentialsProviderError.js [app-route] (ecmascript)");
;
;
const resolveCredentialSource = (credentialSource, profileName, logger)=>{
    const sourceProvidersMap = {
        EcsContainer: async (options)=>{
            const { fromHttp } = await __turbopack_context__.A("[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-http@3.927.0/node_modules/@aws-sdk/credential-provider-http/dist-es/index.js [app-route] (ecmascript, async loader)");
            const { fromContainerMetadata } = await __turbopack_context__.A("[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@smithy+credential-provider-imds@4.2.4/node_modules/@smithy/credential-provider-imds/dist-es/index.js [app-route] (ecmascript, async loader)");
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is EcsContainer");
            return async ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cogni$2f$cogni$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$smithy$2b$property$2d$provider$40$4$2e$2$2e$4$2f$node_modules$2f40$smithy$2f$property$2d$provider$2f$dist$2d$es$2f$chain$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["chain"])(fromHttp(options ?? {}), fromContainerMetadata(options))().then(setNamedProvider);
        },
        Ec2InstanceMetadata: async (options)=>{
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Ec2InstanceMetadata");
            const { fromInstanceMetadata } = await __turbopack_context__.A("[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@smithy+credential-provider-imds@4.2.4/node_modules/@smithy/credential-provider-imds/dist-es/index.js [app-route] (ecmascript, async loader)");
            return async ()=>fromInstanceMetadata(options)().then(setNamedProvider);
        },
        Environment: async (options)=>{
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
            const { fromEnv } = await __turbopack_context__.A("[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-env@3.927.0/node_modules/@aws-sdk/credential-provider-env/dist-es/index.js [app-route] (ecmascript, async loader)");
...
const setNamedProvider = (creds)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cogni$2f$cogni$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$aws$2d$sdk$2b$core$40$3$2e$927$2e$0$2f$node_modules$2f40$aws$2d$sdk$2f$core$2f$dist$2d$es$2f$submodules$2f$client$2f$setCredentialFeature$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setCredentialFeature"])(creds, "CREDENTIALS_PROFILE_NAMED_PROVIDER", "p");
}),
"[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-ini@3.927.0/node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveAssumeRoleCredentials.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}, resolveProfileData)=>{
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await __turbopack_context__.A("[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+nested-clients@3.927.0/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/index.js [app-route] (ecmascript, async loader)");
    ...
    if (isCredentialSourceWithoutRoleArn(profileData)) {
        ...
        return options.roleAssumer(sourceCreds, params).then((creds)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cogni$2f$cogni$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$aws$2d$sdk$2b$core$40$3$2e$927$2e$0$2f$node_modules$2f40$aws$2d$sdk$2f$core$2f$dist$2d$es$2f$submodules$2f$client$2f$setCredentialFeature$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setCredentialFeature"])(creds, "CREDENTIALS_PROFILE_SOURCE_PROFILE", "o"));
    }
};
...
"[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-ini@3.927.0/node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveProcessCredentials.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const resolveProcessCredentials = async (options, profile)=>__turbopack_context__.A("[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-process@3.927.0/node_modules/@aws-sdk/credential-provider-process/dist-es/index.js [app-route] (ecmascript, async loader)").then(({ fromProcess })=>fromProcess({
            ...options,
            profile
        })().then((creds)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cogni$2f$cogni$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$aws$2d$sdk$2b$core$40$3$2e$927$2e$0$2f$node_modules$2f40$aws$2d$sdk$2f$core$2f$dist$2d$es$2f$submodules$2f$client$2f$setCredentialFeature$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setCredentialFeature"])(creds, "CREDENTIALS_PROFILE_PROCESS", "v")));
}),
"[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-ini@3.927.0/node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveSsoCredentials.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const resolveSsoCredentials = async (profile, profileData, options = {})=>{
    const { fromSSO } = await __turbopack_context__.A("[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.927.0/node_modules/@aws-sdk/credential-provider-sso/dist-es/index.js [app-route] (ecmascript, async loader)");
    return fromSSO({
        profile,
        logger: options.logger,
...
"[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-ini@3.927.0/node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveStaticCredentials.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-ini@3.927.0/node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveWebIdentityCredentials.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const resolveWebIdentityCredentials = async (profile, options)=>__turbopack_context__.A("[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-web-identity@3.927.0/node_modules/@aws-sdk/credential-provider-web-identity/dist-es/index.js [app-route] (ecmascript, async loader)").then(({ fromTokenFile })=>fromTokenFile({
...
"[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-ini@3.927.0/node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveProfileData.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-ini@3.927.0/node_modules/@aws-sdk/credential-provider-ini/dist-es/fromIni.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const fromIni = (_init = {})=>async ({ callerClientConfig } = {})=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cogni$2f$cogni$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$aws$2d$sdk$2b$credential$2d$provider$2d$ini$40$3$2e$927$2e$0$2f$node_modules$2f40$aws$2d$sdk$2f$credential$2d$provider$2d$ini$2f$dist$2d$es$2f$resolveProfileData$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveProfileData"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cogni$2f$cogni$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$smithy$2b$shared$2d$ini$2d$file$2d$loader$40$4$2e$3$2e$4$2f$node_modules$2f40$smithy$2f$shared$2d$ini$2d$file$2d$loader$2f$dist$2d$es$2f$getProfileName$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProfileName"])({
            profile: _init.profile ?? callerClientConfig?.profile
        }), profiles, init);
    };
}),
"[project]/code/cogni/cogni-frontend/node_modules/.pnpm/@aws-sdk+credential-provider-ini@3.927.0/node_modules/@aws-sdk/credential-provider-ini/dist-es/index.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "fromIni",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cogni$2f$cogni$2d$frontend$2f$node_modules$2f2e$pnpm$2f40$aws$2d$sdk$2b$credential$2d$provider$2d$ini$40$3$2e$927$2e$0$2f$node_modules$2f40$aws$2d$sdk$2f$credential$2d$provider$2d$ini$2f$dist$2d$es$2f$fromIni$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fromIni"]
]);
...
//# sourceMappingURL=2b0ea_%40aws-sdk_credential-provider-ini_dist-es_6bfa5b5c._.js.map